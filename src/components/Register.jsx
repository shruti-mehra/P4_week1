    ...
    <section className='h-screen flex items-center justify-center'>
      <div className='max-w-sm border shadow bg-white mx-auto p-8'>
        ...
        <input type="text" name="username" id="username"     
             ...
             className='w-full bg-gray-100 focus:none px-5 py-3'/>
        ...
        <p className='my-5 italic text-sm  text-center'>Already have an account? Please <Link className='text-red-700 px-1 underline' to="/login">Login</Link></p>
      </div>
    </section>
  )
}
